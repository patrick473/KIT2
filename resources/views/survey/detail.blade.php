...
@section('content')
  <div class="card">
      ...
      <br/>
      <a href='view/{{$survey->id}}'>Take Survey</a> | <a href="{{$survey->id}}/edit">Edit Survey</a> | <a href="/survey/answers/{{$survey->id}}">View Answers</a> | <a href="#doDelete"  class="modal-trigger red-text">Delete Survey</a>
      <!-- Modal Structure -->
      ...
      <!-- end of not working delete modal -->
              ...
              <div style="margin:5px; padding:10px;">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="textarea1" class="materialize-textarea"></input>
